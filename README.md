...
Bombable MPCarriers are compatible with default MPCarriers, however, some feautures as MP lights and elevators will 
 fully work only at Nimitz and Clemenceau at the time.

To change position of MPCarrier, navigate to fgdata/AI folder and find desired Carrier. Open the file and
 change latitude and longitude coordinates.  
